        ...
        >
          <ul className={styles.instructionUl}>
            ...
            <li>
              ...
              отчет из BI "Данные о поставках и планировании" в формате Excel по одному складу и загрузить его во
              второе окно и нажать кнопку "Сформировать файл
              APEX или НСИ".
            </li>
            <li>
              Примечание: Если формируемый файл содержит более 9990 строк, то
