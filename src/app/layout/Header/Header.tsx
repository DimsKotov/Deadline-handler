        ...
        >
          <ul className={styles.instructionUl}>
            <li>
              ...
              APEX". Сохраняем готовый к загрузке в APEX файл.
            </li>
            <li>
              ...
              второе окно и нажать кнопку "Сформировать файл APEX". Сохраняем
              готовый к загрузке в APEX файл.
            </li>
            <li>
              Примечание: Если формируемый файл содержит более 10000 строк, то
              он автоматически будет разбит на части и поочередно предложен к
              скачиванию. Если разбитие по частям не требуется, переключите
              тумблер "Разбивать файл".
            </li>
          </ul>
        </div>
      )}
